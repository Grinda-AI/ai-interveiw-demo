...
const questions = [
  {
    id: 1,
    name: "팀 구성",
    description: "팀 구성이 적절한지 물어봐요",
    difficulty: "Easy",
  },
  {
    id: 2,
    name: "기술성 입증",
    description: "기술적으로 가능한지에 대해 물어봐요",
    difficulty: "Medium",
  },
  {
    id: 3,
    name: "비즈니스 모델",
    description: "비즈니스 모델에 대해 깊게 물어봐요",
    difficulty: "Hard",
  },
];
...
const interviewers = [
  {
    id: "John",
    name: "John",
    description: "전략적이고 종합적인 질문을 선호해요",
    level: "L3",
  },
  {
    id: "Richard",
    name: "Richard",
    description: "보수적으로 생각해요",
    level: "L5",
  },
  {
    id: "Sarah",
    name: "Sarah",
    description: "구체적인 데이터를 선호해요",
    level: "L7",
  },
];
    ...
    if (recordedChunks.length) {
      ...
      const question =
        selected.name === "Behavioral"
          ...
          ? "당신의 타깃 시장은 얼마나 큰가요? 그리고 이 시장의 성장 가능성은 어떠한가요?"
              ...
              >
                <div className="flex flex-row items-center space-x-1">
                  ...
                  <p className="text-[14px] font-normal leading-[20px] text-[#1a2b3b]">
                    녹화된 비디오는 서버에 저장되지 않으며, 서비스 이용 후 자동으로 삭제됩니다.
                  </p>
                </div>
                <Link
              ...
              {recordingPermission ? (
                <div className="w-full flex flex-col max-w-[1080px] mx-auto justify-center">
                  ...
                  >
                    ...
                    <p className="text-[14px] font-normal leading-[20px] text-[#1a2b3b]">
                      비디오는 녹화되지 않으며, 녹화된 비디오는 오로지 서비스 이용 목적으로만 사용됩니다.
                    </p>
                  </motion.div>
                </div>
              ) : (
              ...
              {step === 1 ? (
                ...
                >
                  ...
                  <p className="text-[14px] leading-[20px] text-[#1a2b3b] font-normal my-4">
                    국내 TOP VC들이 주로 하는 질문 유형을 모아봤어요!
                  </p>
                  <div>
                ...
                >
                  ...
                  <p className="text-[14px] leading-[20px] text-[#1a2b3b] font-normal my-4">
                    다른 투자심사역과 하고 싶다면, 이 페이지로 다시 돌아올 수 있어요.
                  </p>
                  <div>
                    <RadioGroup
              ...
              >
                <ul className="mb-auto list-none">
                  ...
                  <li className="mt-1 list-none flex items-center rounded-[9px] text-gray-900 py-[4px]">
                    ...
                    <p className="ml-[3px] mr-[6px]">인공지능 VC</p>
                  ...
                  <li className="mt-1 list-none flex items-center rounded-[9px] text-gray-900 py-[4px]">
                    ...
                    <p className="ml-[3px] mr-[6px]">나의 질문들</p>
                  </li>
                  <li className="mt-1 list-none flex items-center rounded-[9px] text-gray-900 py-[4px]">
                    <svg
                      className="h-4 w-4 text-gray-700"
                    ...
                    <p className="ml-[3px] mr-[6px]">커뮤니티</p>
                  </li>
                  <li className="mt-1 list-none flex items-center rounded-[9px] text-gray-900 py-[4px]">
                    <svg
                      className="h-4 w-4 text-gray-700"
                    ...
                    <p className="ml-[3px] mr-[6px]">자료 모음집</p>
                  </li>
                  <li className="mt-1 list-none flex items-center rounded-[9px] text-gray-900 py-[4px]">
                    <svg
                      className="h-4 w-4 text-gray-700"
                    ...
                    <p className="ml-[3px] mr-[6px]">세부 설정</p>
                  </li>
                </ul>
                  ...
                  <div>
                    ...
                    <ul className="mt-[28px] flex">
                      <li className="list-none max-w-[400px]">
                        나올 수 있는 모든 VC의 질문을 인공지능을 통해 분석해드려요. 
                        만약에 당신이 원하는 질문이 나오지 않는다면,
                        그린다 에이아이에게 알려주세요!
                      </li>
                    </ul>
                  </div>
